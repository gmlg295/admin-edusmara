...
{
    protected $modelName = 'App\Models\AbsensiModel';
    protected $format    = 'json';

    // GET /kelas - Mengambil data dengan Pagination & Search
     public function index()
    {
        return view('content/siswa/absensi_siswa', [
            'title' => 'Absensi Siswa - EDUSMARA',
            'active' => 'master',
            'load_js' => 'page/siswa/absensi_siswa.js',
            'load_css' => 'page/siswa/absensi-style.css',
            'enable_menu' => false,
        ]);
    }
