...
<div class="custom-container">
    <!-- ============ TABS ============ -->
    <div class="page-tabs">
        <button class="page-tab active" data-tab="list"><i class="fa-solid fa-users"></i><span>Data Guru</span></button>
    ...
    <div class="tab-content active" id="tab-list">
        <div class="summary-grid">
            <div class="summary-card">
                ...
                <div><div class="summary-value" id="sumTotal">0</div><div class="summary-label">Total Guru</div></div>
            </div>
            <div class="summary-card">
        ...
        <div class="toolbar">
            ...
            <button class="btn-add" onclick="switchToForm()"><i class="fa-solid fa-plus"></i><span>Tambah Guru</span></button>
        </div>
    ...
    <div class="tab-content" id="tab-form">
        <div class="form-card">
            <div class="form-header">
                <h3 id="formTitle"><i class="fa-solid fa-user-plus"></i> Tambah Data Guru Baru</h3>
                <p id="formSubtitle">Lengkapi profil guru dengan benar</p>
            </div>
            <div class="form-body">
                <form id="guruForm">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn-primary-custom" id="btnSubmit"><i class="fa-solid fa-floppy-disk"></i> Simpan Data Guru</button>
                    </div>
                </form>
            </div> 
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-action-footer">
                ...
                <button class="modal-action-btn delete" onclick="openDeleteConfirm()"><i class="fa-solid fa-trash-can"></i><span>Hapus Guru</span></button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            <div class="modal-body-custom" style="padding:30px 24px;text-align:center;">
                ...
                <h4 class="confirm-title">Hapus Data Guru?</h4>
