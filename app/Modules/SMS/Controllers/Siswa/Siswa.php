...
class Siswa extends ResourceController
{
     ...
     public function index()
    {
        return view('content/siswa/siswa', [
            'title' => 'Siswa - EDUSMARA',
            'active' => 'master',
            'load_js' => 'page/siswa/siswa.js',
            'load_css' => 'page/siswa/siswa-style.css',
            'enable_menu' => false,
        ]);
    }
    ...
    {
        return view('content/siswa/import_siswa', [
            'title' => 'Siswa - EDUSMARA',
            'active' => 'master',
            'load_js' => 'page/siswa/import_siswa.js',
            'load_css' => 'page/siswa/import-style.css',
            'enable_menu' => false,
        ]);
    }
